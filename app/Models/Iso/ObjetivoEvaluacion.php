...
class ObjetivoEvaluacion extends Model
{
    ...
    protected $fillable = ['objetivo_id', 'fecha_evaluacion', 'tipo', 'resultado', 'cumplimiento', 'conclusion', 'justificacion', 'decision', 'proxima_evaluacion', 'documento_id', 'enlace_externo', 'evaluado_por'];
