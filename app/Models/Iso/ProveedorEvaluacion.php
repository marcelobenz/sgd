...
class ProveedorEvaluacion extends Model
{
    ...
    protected $fillable = ['proveedor_id', 'periodo_id', 'fecha_evaluacion', 'tipo', 'evaluacion_anterior_id', 'calificaciones', 'puntaje', 'resultado', 'decision', 'estado_ciclo', 'conclusion', 'justificacion', 'proxima_evaluacion', 'requiere_analisis_riesgo', 'documento_id', 'enlace_externo', 'evaluado_por'];
