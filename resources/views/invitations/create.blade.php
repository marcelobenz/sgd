...
@section('heading')
    <style>
        ...
        .tabla-invitaciones th,
        .tabla-invitaciones td {
            vertical-align: middle;
        }

        .tabla-invitaciones td.email-col {
            min-width: 260px;
        }

        .tabla-invitaciones td.acciones-col {
            min-width: 180px;
        }
...
@section('contenidoPrincipal')
    <div class="container-fluid invitation-wrapper">
        <div class="invitation-page">
            <div class="invitation-card card">
                ...
                <div class="card-body">
                    <div class="invitation-intro mb-4">
                    ...
                    <form method="POST" action="{{ route('invitations.store') }}" class="invitation-form-box">
                        @csrf

                        <div class="row align-items-end">
                            <div class="col-lg-8 col-md-12">
                                <div class="form-group mb-3">
                                    <label for="email" class="form-label-strong">Email a invitar</label>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover tabla-invitaciones">
                            ...
                            <tbody>
                                @forelse($invitations as $inv)
                                    ...
                                    <tr>
                                        <td class="email-col">{{ $inv->email }}</td>
                                        ...
                                        <td class="acciones-col">
                                            @if ($inv->isPending())
                                                <div class="d-flex flex-column flex-md-row" style="gap: 6px;">
                                                    <form method="POST"
                                                        action="{{ route('invitations.resend', $inv->id) }}">
                                                        @csrf
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('invitations.revoke', $inv->id) }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center text-muted">No hay invitaciones registradas.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
