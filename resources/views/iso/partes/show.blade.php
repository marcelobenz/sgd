...
<div class="iso-shell">
    ...
    <div class="row">
        ...
        <div class="col-lg-7 mb-4">
            @if(auth()->user()->puedeGestionarPlanificacion() && $parte->estado==='activa' && $periodos->isNotEmpty())
