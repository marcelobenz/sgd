...
<div class="iso-shell">
    ...
    @if($periodo)
        <div class="iso-kpi-row">
            ...
            <div class="iso-kpi"><strong>{{ $stats['verificaciones_pendientes'] }}</strong><span>Verificaciones pendientes</span></div>
        </div>
    @endif
