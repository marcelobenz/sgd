...
<div class="iso-shell">
    ...
    <div class="tab-content pt-3">
        ...
        <div id="evaluaciones" class="tab-pane fade">
            ...
            @endforeach
            @if(auth()->user()->puedeGestionarPlanificacion() && $proveedor->estado==='activo')
